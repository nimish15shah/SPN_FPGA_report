...
\begin{tikzpicture}
    ...
    \draw [decorate, decoration={brace, amplitude=5pt, raise=5pt}] (exponent.north west) -- (exponent.north east) node[midway, yshift=2em] {rs};
    \draw [decorate, decoration={brace, amplitude=5pt, raise=5pt}] (regime.north west) -- (regime.north east) node[midway, yshift=2em] {es};
    \draw [decorate, decoration={brace, amplitude=5pt, raise=5pt}] (fraction.north west) -- (fraction.north east) node[midway, yshift=2em] {fs};
