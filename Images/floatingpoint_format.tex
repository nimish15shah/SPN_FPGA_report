...
\begin{tikzpicture}
    \node [draw, fill=blue!20, minimum width=2cm, minimum height=1cm] (exponent) [] {Exponent};
    \node [draw, fill=blue!20, minimum width=5cm, minimum height=1cm] (fraction) [right=0cm of exponent] {Fraction};
    \node [draw, fill=gray!20, minimum width=1cm, minimum height=1cm] (sign) [left=0cm of exponent] {$\cancel{s}$};
\end{tikzpicture}
