...
\setup{title={Low precision artihmetic using posit in sum product networks over FPGA and error bound analysis},
  author={Antoine \textsc{Gennart}},
  promotor={Prof.\ Marian \textsc{Verhelst}},
  assessor={Prof.\ Luc \textsc{De Raedt} \\Prof.\ Nele \textsc{Mentens} },
...
\newacronym{asic}{ASIC}{application-specific itegrated circuit}
\newacronym{lsb}{LSB}{least significant bit}
\newacronym{fifo}{FIFO}{first in first out}
\newacronym{psdd}{PSDD}{probabilistic sequential decision diagram}
